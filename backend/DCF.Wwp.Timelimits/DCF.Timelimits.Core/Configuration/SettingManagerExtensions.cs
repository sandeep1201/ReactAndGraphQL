...
namespace DCF.Core.Configuration
{
    ...
    public static class SettingManagerExtensions
    {
        ...
        public static async Task<T> GetSettingValueForUserAsync<T>(this ISettingManager settingManager, String name, Int64 userId)
           where T : struct
        {
        ...
        /// <param name="userId">User id</param>
        /// <returns>Current value of the setting for the user</returns>
        public static String GetSettingValueForUser(this ISettingManager settingManager, String name, Int64 userId)
        {
        ...
        /// <param name="userId">User id</param>
        /// <returns>Current value of the setting for the user</returns>
        public static T GetSettingValueForUser<T>(this ISettingManager settingManager, String name, Int64 userId)
            where T : struct
        {
        ...
        /// <param name="name">Unique name of the setting</param>
        /// <param name="value">Value of the setting</param>
        public static void ChangeSettingForUser(this ISettingManager settingManager, Int64 userId, String name, String value)
        {
