...
namespace DCF.Common.Reflection
{
    /// <summary>
    ...
    public static class ReflectionHelper
    {
        ...
        public static IEnumerable<Type> GetImplementedOpenGenericType(Type givenType, Type openGenericType)
        {
            ...
            var baseTypes = GetBaseTypes(givenType);

            foreach (var iType in baseTypes)
            {
                if (!iType.IsGenericType || iType.GetGenericTypeDefinition() != openGenericType)
                {
                    continue;
                }
            ...
            var iTypes = givenType.GetInterfaces();
        ...
        private static IEnumerable<Type> GetBaseTypes(Type givenType)
        {
            ...
            types.AddRange(ReflectionHelper.GetBaseTypes(givenType.BaseType));
            return types;
        ...
        internal static void SetValueByPath(Object obj, Type objectType, String propertyPath, Object value)
        {
            ...
            for (Int32 i = 0; i < properties.Length - 1; i++)
            {
