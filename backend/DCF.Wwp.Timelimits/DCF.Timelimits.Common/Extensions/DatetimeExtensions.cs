...
namespace DCF.Common.Extensions
{
    public static class DatetimeExtensions
    {
        ...
        public static Boolean IsBefore(this System.DateTime dateTime, System.DateTime compareDateTime, DateTimeUnit unit = DateTimeUnit.Millisecond)
        {
            return dateTime.EndOf(unit) < compareDateTime.EndOf(unit);
        }

        public static Boolean IsSameOrBefore(this System.DateTime dateTime, System.DateTime compareDateTime, DateTimeUnit unit = DateTimeUnit.Millisecond)
        {
        ...
        /// <returns>boolean</returns>
        public static Boolean IsAfter(this System.DateTime dateTime, System.DateTime compareDateTime, DateTimeUnit unit = DateTimeUnit.Millisecond)
        {
        ...
        /// <param name="unit"><see cref="DateTimeUnit"/></param>
        /// <returns>boolean</returns>
        public static Boolean IsSame(this System.DateTime dateTime, System.DateTime compareDateTime, DateTimeUnit unit = DateTimeUnit.Millisecond)
        {
            return dateTime.StartOf(unit) <= compareDateTime.StartOf(unit) && compareDateTime.EndOf(unit) <= dateTime.EndOf(unit);
        }

        public static Boolean IsSameOrAfter(this System.DateTime dateTime, System.DateTime compareDateTime,
        ...
        /// <param name="unit"><see cref="DateTimeUnit"/></param>
        /// <returns>boolean</returns>
        public static Boolean IsBetween(this System.DateTime dateTime, System.DateTime fromDate, System.DateTime toDate,
            DateTimeUnit unit = DateTimeUnit.Millisecond)
        {
        ...
        public static System.DateTime StartOf(this System.DateTime dateTime, DateTimeUnit unit)
        {
            switch (unit)
            {
                ...
                case DateTimeUnit.Day:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 0, 0, 0, 0);
                case DateTimeUnit.Hour:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, 0, 0, 0);
                case DateTimeUnit.Minute:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute, 0, 0);
        ...
        public static System.DateTime EndOf(this System.DateTime dateTime, DateTimeUnit unit)
        {
            switch (unit)
            {
                case DateTimeUnit.Year:
                ...
                case DateTimeUnit.Day:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 23, 59, 59, 0);
                case DateTimeUnit.Hour:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, 59, 59, 0);
                case DateTimeUnit.Minute:
                    return new System.DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute, 59, 0);
                case DateTimeUnit.Second:
