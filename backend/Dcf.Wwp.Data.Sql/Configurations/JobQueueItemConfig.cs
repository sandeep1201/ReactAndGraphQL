...
{
    public class JobQueueItemConfig : BaseConfig<JobQueueItem>
    {
        public JobQueueItemConfig()
        {
            #region Relationships

            HasRequired(p => p.JobQueue)
                .WithMany(p => p.JobQueueItems)
