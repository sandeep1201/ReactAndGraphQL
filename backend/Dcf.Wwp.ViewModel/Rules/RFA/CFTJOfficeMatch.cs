...
namespace Dcf.Wwp.Api.Library.Rules.RFA
{
    // US 1439
    [Tag("RFA-Validate")]
    [Name("CFTJOfficeMatch")]
    public class CFTJOfficeMatch : Rule
    {
        // RFA for TJ First should match the office number for the CF office.
        public override void Define()
        {
            ...
            When()
                ...
                .Match<RequestForAssistanceContract>(() => contract,  c => c != null && c.IsTJ)
        ...
        private void CreateMsg(MessageCodeLevelContext messageCodeLevelResult, List<IParticipantEnrolledProgram> peps)
        {
            ...
            var ruleForcingPep = peps.First(x => x.IsCF && (x.IsReferred || x.IsEnrolled));
