...
{
    public class JWWWP02 : IBatchJob
    {
        #region Properties
        ...
        public string Desc    => "Non-Eligiable Disenrollment Update";
        public string Sproc   => "wwp.SP_DB2_NE_Disenrollment_Update";
        ...
        public JWWWP02(IDbConfig dbConfig, IProgramOptions options, ILog log)
        {
            _dbConfig = dbConfig;
            _options  = options;
            _log      = log;
