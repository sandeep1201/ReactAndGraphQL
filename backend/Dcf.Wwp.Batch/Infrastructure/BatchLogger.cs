...
namespace Dcf.Wwp.Batch.Infrastructure
{
    public static class BatchLogger
    {
        ...
        public static void Configure()
        {
            ...
            ////var log = LogManager.GetLogger("log4net-default-repository", "Dcf.Wwp.Batch.WWP00");
            //var log = LogManager.GetLogger(log4net-default-repository", "Dcf.Wwp.Batch.Models");
