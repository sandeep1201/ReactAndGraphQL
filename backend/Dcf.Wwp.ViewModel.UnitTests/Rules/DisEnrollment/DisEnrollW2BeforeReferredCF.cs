...
namespace Dcf.Wwp.ViewModel.UnitTests.Rules.DisEnrollment
{
    ...
    [TestClass]
    public class DisEnrollW2BeforeReferredCF : BaseUnitTest
    {
       
        [TestMethod]
        public void DisEnrollW2BeforeReferredCF_DisEnrollW2EnrolledWhenCFReferred_ShowErrorCFMustBeEnrolledThenDisEnrolled()
        {
        ...
        [TestMethod]
        public void DisEnrollW2BeforeReferredCF_DisEnrollW2EnrolledWhenCFNotThere_DoNotShowShowErrorCFMustBeEnrolledThenDisEnrolled()
        {
