...
using Dcf.Wwp.Api.Core.EntSec.SimpleTokenProvider;
...
namespace Dcf.Wwp.Api.Core.EntSec
{
    ...
    public static class TokenProviderAppBuilderExtensions
    {
        ...
        public static IApplicationBuilder UseEntSecTokenProvider(this IApplicationBuilder app, TokenProviderOptions options)
        {
            if (app == null)
            {
