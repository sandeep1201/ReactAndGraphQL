...
namespace Dcf.Wwp.ConnectedServices.Cww
{
    ...
    public interface ICwwIndServiceChannel : ICwwIndService, IClientChannel
    {
    }

    [ServiceContract(Namespace = "http://individual.services.business.cares.wisconsin.gov/", ConfigurationName = "CWWIndividualService")]
    public interface ICwwIndService
    {
        [XmlSerializerFormat]
    ...
    public  class CwwIndServiceClient : ClientBase<ICwwIndService>, ICwwIndService
    {
        public CwwIndServiceClient()
        {
        }

        public CwwIndServiceClient(string endpointConfigurationName) : base(endpointConfigurationName)
        {
        }

        public CwwIndServiceClient(string endpointConfigurationName, string remoteAddress) : base(endpointConfigurationName, remoteAddress)
        {
        }

        public CwwIndServiceClient(string endpointConfigurationName, EndpointAddress remoteAddress) : base(endpointConfigurationName, remoteAddress)
        {
        }

        public CwwIndServiceClient(Binding binding, EndpointAddress remoteAddress) : base(binding, remoteAddress)
        {
        }
    ...
    public  class GetIndvDemographicsRequest
    {
    ...
    public  class GetIndvDemographicsResponse
    {
    ...
    public  class InsertIndvKeyDemographicsRequest
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 0)] [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public IndividualType Individual;
    ...
    public  class InsertIndvKeyDemographicsResponse
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 2)] [XmlArray(Form = XmlSchemaForm.Unqualified)] [XmlArrayItem("ValidationError", Form = XmlSchemaForm.Unqualified, IsNullable = false)]
        public ValidationErrorType[] Errors;
    ...
    public  class UpdateIndvKeyDemographicsRequest
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 0)] [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public IndividualType Individual;
    ...
    public  class UpdateIndvKeyDemographicsResponse
    {
    ...
    public  class UpdateRaceEthnicityInformationRequest
    {
    ...
    public  class UpdateRaceEthnicityInformationResponse
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 1)] [XmlArray(Form = XmlSchemaForm.Unqualified)] [XmlArrayItem("ValidationError", Form = XmlSchemaForm.Unqualified, IsNullable = false)]
        public ValidationErrorType[] Errors;
    ...
    public class UpdateFEPInformationRequest
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 0)] [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string PINNumber;
        ...
        public UpdateFEPInformationRequest(string PINNumber, string PreviousFEPId, string CurrentFEPId, string WorkerId, string ExternalAgencyId, string IPAddress)
        {
            this.PINNumber        = PINNumber;
    ...
    public  class UpdateFEPInformationResponse
    {
        [MessageBodyMember(Namespace = "http://individual.services.business.cares.wisconsin.gov/", Order = 2)] [XmlArray(Form = XmlSchemaForm.Unqualified)] [XmlArrayItem("ValidationError", Form = XmlSchemaForm.Unqualified, IsNullable = false)]
        public ValidationErrorType[] Errors;
