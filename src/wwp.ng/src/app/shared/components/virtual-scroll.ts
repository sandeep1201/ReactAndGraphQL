/** Modified from https://github.com/rintoj/angular2-virtual-scroll/blob/master/src/virtual-scroll.ts. The MIT License (MIT)
 * Currently only supports vertical aligment. TODO:Modify for horizontal virtual scrolling
 */
import {
    Component,
    ElementRef,
...
@Component({
    ...
    template: `
        <div class="total-padding" [style.width]="scrollHeight + 'px'"></div>
